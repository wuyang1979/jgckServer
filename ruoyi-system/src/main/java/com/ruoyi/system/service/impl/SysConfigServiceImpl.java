...
public class SysConfigServiceImpl implements ISysConfigService {
    ...
    @Override
    public List<SysConfig> selectXyConfigList(SysConfig config) {
        config.setConfigType("N");
        return configMapper.selectConfigList(config);
    }

    @Override
    public SysConfig selectXyConfigById(Long configId) {
        SysConfig config = new SysConfig();
        config.setConfigId(configId);
        SysConfig sysConfig = configMapper.selectConfig(config);
        //sysConfig.setData(JSONObject.parseObject(sysConfig.getConfigValue()));
        sysConfig.setArray(JSONArray.parseArray(sysConfig.getConfigValue()));
        return sysConfig;
    }
